...
def comparativePolarGraph(a1,b1,r1,theta,a2,b2,r2,theta2,a3,b3,r3,theta3,a4,b4,r4,theta4,text,text1,text2,vec,vecs):
    ...
    ax[1, 0].plot(a3,b3,color='blue', ls=':', lw=2,label="")
    ax[1, 0].plot(r3,theta3,color='red', ls='-', lw=2,label="")
    ...
    ax[0, 0].legend(bbox_to_anchor=(1.5, 1.21),loc='best')
...
def two_polar_graph(a1,b1,r1,theta,a4,b4,r4,theta4,text,text1,text2,vec,vecs):
    ...
    ax[0].set_rticks(vecs)
    ax[0].plot(a1,b1, ls=':',color="blue" ,lw=2, label=text1)
    ax[0].plot(r1,theta,color='red', ls='-', lw=2, label= text2)
    ax[1].plot(a4,b4,color='blue', ls=':', lw=2, label=text1)
    ax[1].plot(r4,theta4,color='red', ls='-', lw=2, label=text2)
    ax[1].set_rticks(vec)
    
   
    plt.suptitle(text,fontsize=20)
    ax[0].legend(bbox_to_anchor=(1.5, 1.21),loc='best')
    plt.subplots_adjust(left=0.125,
                    bottom=0.1, 
                    right=0.9, 
                    top=0.9, 
...
#main   
a1,b1 = readData("./Data/port1_new.csv")
a2,b2 = readData("./Data/port2_new.csv") 
a3,b3 = readData("./Data/port3_new.csv")
a4,b4 = readData("./Data/port4_new.csv") 

r1,theta = readData("./Data/port1meta_new.csv")
r2,theta2 = readData("./Data/port2meta_new.csv")
r3,theta3 = readData("./Data/port3meta_new.csv")
r4,theta4 = readData("./Data/port4meta_new.csv")

# A1,B1 = leerDatosSimula("./Data/port1S.txt")
# A2,B2 = leerDatosSimula("./Data/port2S.txt") 
# A3,B3 = leerDatosSimula("./Data/port3S.txt")
# A4,B4 = leerDatosSimula("./Data/port4S.txt") 

# R1,Theta = leerDatosSimula("./Data/port1metaS.txt")
# R2,Theta2 = leerDatosSimula("./Data/port2metaS.txt")
# R3,Theta3 = leerDatosSimula("./Data/port3metaS.txt")
# R4,Theta4 = leerDatosSimula("./Data/port4metaS.txt")
...
vec2 = [-30,-20, -10,0,10]
vec3 = [-30,-20,-10,0]
#two_polar_graph(a1,b1,r1,theta,a2,b2,r2,theta2,a3,b3,r3,theta3,a4,b4,r4,theta4,"","Without MTM","With MTM",vec3,vec3)
two_polar_graph(a1,b1,A1,B1,a2,b2,A2,B2,"","Experimental results","Simulated results",vec,vec2)
two_polar_graph(a3,b3,A3,B3,a4,b4,A4,B4,"","Experimental results","Simulated results",vec,vec2)
two_polar_graph(r1,theta,R1,Theta,r2,theta2,R2,Theta2,"","Experimental results","Simulated results",vec,vec2)
two_polar_graph(r3,theta3,R3,Theta3,r4,theta4,R4,Theta4,"","Experimental results","Simulated results",vec,vec2)
# comparativePolarGraph(a1,b1,r1,theta,a2,b2,r2,theta2,a3,b3,r3,theta3,a4,b4,r4,theta4,"","Without MTM","With MTM",vec3,vec3)
## comparativePolarGraph(a1,b1,A1,B1,a2,b2,A2,B2,a3,b3,A3,B3,a4,b4,A4,B4,"","Experimental results","Simulated results",vec,vec2)
# comparativePolarGraph(r1,theta,R1,Theta,r2,theta2,R2,Theta2,r3,theta3,R3,Theta3,r4,theta4,R4,Theta4,"","Experimental results","Simulated results",vec,vec2)
